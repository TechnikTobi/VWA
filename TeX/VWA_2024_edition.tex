...
\begin{document}
	...
	\addcontentsline{toc}{chapter}{Anhang}
		...
		\begin{longtable}{p{30mm}p{110mm}} %longtable für mehrseitige Tabelle, sonst tabular
			\hline
			\centering $l$ & Nummer einer Schicht (Indexierung: 1)\newNotationRow	
	...
	\section*{Anhang E: Ergebnisse der Experimente}
		...
		\subsection*{E.1 Tabelle der Ergebnisse der Experimente mit FFNNs}
			\enlargethispage{1\baselineskip} % Nicht Teil der originalen VWA. Allerdings scheinen neue LaTeX Versionen ansonsten hier die letzte Zeile auf dieser Seite abzuschneiden und auf der nächsten einzufügen. Durch das einmalige erlauben des Überschreitens des bottom margins wird die alte Formatierung wiederhergestellt. 
			...
			nohead,column count=12,table head=\hline,late after first line=\\\hline,table foot=\hline\caption{Tabelle mit den Ergebnissen der Experimente mit FFNNs (Quelle: Eigene Tabelle)}]{csv/ergebnisseFFNNfinal6.csv}{}{\csviffirstrow{\myrot{i} & \myrot{ii} & \myrot{iii} & \myrot{iv} & \myrot{v} & \myrot{vi} & \myrot{vii} & \myrot{viii} & \myrot{ix} & \myrot{x} & \myrot{xi} & \myrot{xii}}{\csvlinetotablerow}}
		...
		\subsection*{E.2 Tabelle der Ergebnisse der Experimente mit CNNs}
			...
			nohead,column count=13,table head=\hline,late after first line=\\\hline,table foot=\hline\caption{Tabelle mit den Ergebnissen der Experimente mit CNNs (Quelle: Eigene Tabelle)}]{csv/ergebnisseCNNfinal6.csv}{}{\csviffirstrow{\myrot{i} & \myrot{ii} & \myrot{iii} & \myrot{iv} & \myrot{v} & \myrot{vi} & \myrot{vii} & \myrot{viii} & \myrot{ix} & \myrot{x} & \myrot{xi} & \myrot{xii} & \myrot{xiii}}{\csvlinetotablerow}}
		...
		\subsection*{E.3 Tabelle der Ergebnisse der Experimente mit LSTMs}
			...
			column count=13,table head=\hline,late after first line=\\\hline,table foot=\hline\caption{Tabelle mit den Ergebnissen der Experimente mit LSTMs (Quelle: Eigene Tabelle)}]{csv/ergebnisseLSTMfinal6.csv}{}{\csviffirstrow{\myrot{i} & \myrot{ii} & \myrot{iii} & \myrot{iv} & \myrot{v} & \myrot{vi} & \myrot{vii} & \myrot{viii} & \myrot{ix} & \myrot{x} & \myrot{xi} & \myrot{xii} & \myrot{xiii}}{\csvlinetotablerow}}
